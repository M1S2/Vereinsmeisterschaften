...
namespace Vereinsmeisterschaften.Core.Analytics
{
    ...
    /// </summary>
    public class AnalyticsModuleDistancesBetweenStarts : IAnalyticsModule
    {
        private IRaceService _raceService;

        /// <summary>
        /// Constructor for the <see cref="AnalyticsModuleDistancesBetweenStarts"/>
        /// </summary>
        /// <param name="raceService"><see cref="IRaceService"/> object</param>
        public AnalyticsModuleDistancesBetweenStarts(IRaceService raceService)
        {
